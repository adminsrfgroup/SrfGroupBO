...
import {
  addTopSlides,
  addTopSlidesSuccess,
  fetchOneTopSlides, fetchOneTopSlidesSuccess,
  fetchTopSlides,
...
describe('HomeEffects', () => {
  ...
  const MockHomeService = jasmine.createSpyObj('homeService', [
    'addTopSlide', 'fetchTopSlide', 'fetchOneTopSlide', 'updateTopSlide'
  ]);
