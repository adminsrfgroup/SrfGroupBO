...
export const addFeatureSlideFailure = createAction('[FeatureSlide] Add FeatureSlide Failure', props<{ error: string }>());
...
export const fetchFeatureSlidesFailure = createAction('[FeatureSlide] fetch FeatureSlide Failure', props<{ error: string }>());

export const fetchOneFeatureSlide = createAction('[FeatureSlide] Fetch One FeatureSlide', props<IdEntity>());
...
export const fetchOneFeatureSlideFailure = createAction('[FeatureSlide] fetch One FeatureSlide Failure', props<{ error: string }>());
...
export const updateFeatureSlideFailure = createAction('[FeatureSlide] Update FeatureSlide Failure', props<{ error: string }>());
...
export const deleteFeatureSlideFailure = createAction('[FeatureSlide] Delete FeatureSlide Failure', props<{ error: string }>());
