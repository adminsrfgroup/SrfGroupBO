...
export const fetchOneTopSlides = createAction('[TopSlide] FetchOne TopSlide', props<IFetchOneTopSlide>());
...
export const deleteTopSlides = createAction('[TopSlide] Delete TopSlide', props<IFetchOneTopSlide>());
