...
export const addTopSlidesFailure = createAction('[TopSlide] Add TopSlide Failure', props<{ error: string }>());
...
export const fetchTopSlidesFailure = createAction('[TopSlide] fetch TopSlide Failure', props<{ error: string }>());
...
export const fetchOneTopSlidesFailure = createAction('[TopSlide] FetchOne TopSlide Failure', props<{ error: string }>());
...
export const updateTopSlidesFailure = createAction('[TopSlide] Update TopSlide Failure', props<{ error: string }>());
...
export const deleteTopSlidesFailure = createAction('[TopSlide] Delete TopSlide Failure', props<{ error: string }>());
