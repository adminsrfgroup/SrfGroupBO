...
export const loadListUsers = createAction('[ListUser] Load ListUsers');

export const loadListUsersSuccess = createAction('[ListUser] Load ListUsers Success', props<{ payload: PageCommon<IUser> }>());

export const loadListUsersFailure = createAction('[ListUser] Load ListUsers Failure', props<{ error: any }>());
