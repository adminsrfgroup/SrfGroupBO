...
describe('ListUserEffects', () => {
    ...
    const MockUserService = jasmine.createSpyObj('listUsersService', ['fetchAllUsers']);

    beforeEach(() => {
        TestBed.configureTestingModule({
            imports: [HttpClientTestingModule],
            providers: [ListUserEffects, provideMockActions(() => actions$), { provide: ListUsersService, useValue: MockUserService }],
        });
