...
@NgModule({
    declarations: [ListRoleComponent, AddUpdateRoleComponent, ListPermissionComponent, AddUpdatePermissionComponent],
    imports: [CommonModule, RoleManagmentRoutingModule, ReactiveFormsModule, SharedModule],
})
