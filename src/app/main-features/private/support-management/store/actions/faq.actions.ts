...
export const updateFaqFailure = createAction('[UpdateFaq] Load UpdateFaq Failure', props<{ error: any }>());
...
export const fetchOneFaqFailure = createAction('[FetchOneFaq] Load FetchOneFaq Failure', props<{ error: any }>());
