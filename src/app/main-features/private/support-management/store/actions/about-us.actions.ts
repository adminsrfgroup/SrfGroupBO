...
export const loadListAboutUsFailure = createAction('[ListAboutUs] Load ListAboutUs Failure', props<{ error: string }>());
...
export const addAboutUsFailure = createAction('[AddAboutUs] Load AddAboutUs Failure', props<{ error: string }>());
...
export const fetchOneAboutUsFailure = createAction('[FetchOneAddAboutUs] Load FetchOneAddAboutUs Failure', props<{ error: string }>());
