            ...
            OrgChart._intersectionObserver(this.element, function (t) {
                (r.isVisible = t),
                    !1 !== OrgChart.events.publish('visibility-change', [r]) &&
                        ...
                        r.isVisible &&
                        (r._loaded ? r._draw(!1, OrgChart.action.update) : (r._setInitialSizeIfNotSet(), r._draw(!1, OrgChart.action.init)));
            }));
};
(OrgChart._defaultConfig = function (t) {
                            ...
                            if (!1 !== a.config.lazyLoading || !0 !== t || e === OrgChart.action.exporting) {
                                ...
                                if ((OrgChart.events.publish('render', [a, o]), (l = o.content), (n = o.res), (l += a.ui.lonely(a.config)), e !== OrgChart.action.exporting)) {
                                    ...
                                    e === OrgChart.action.centerNode
                                        ...
                                        : !h ||
                                          !a.response ||
                                          (h[0] == a.response.viewBox[0] && h[1] == a.response.viewBox[1] && h[2] == a.response.viewBox[2] && h[3] == a.response.viewBox[3]) ||
                                        ...
                                        : OrgChart.animate(a.getSvg(), { viewbox: h }, { viewbox: a.response.viewBox }, 2 * a.config.anim.duration, a.config.anim.func, function () {
                ...
                for (var t = '', r = 0; r < l.length; r++) {
                    ...
                    if (Array.isArray(i)) {
                        ...
                        for (var a = 0; a < i.length; a++) {
                            ...
                            !OrgChart.isNEU(s.id) && OrgChart.isNEU(n) && OrgChart.isNEU(s.value) && (n = s.id), OrgChart.isNEU(s.value) || E.push(`${o.label}: ${s.value}`), (t += s.html);
                        }
                        t += '</div>';
                    } else {
                        s = OrgChart.elements[i.type](f, i, '280px', e);
                        !OrgChart.isNEU(s.id) && OrgChart.isNEU(n) && OrgChart.isNEU(s.value) && (n = s.id), OrgChart.isNEU(s.value) || E.push(`${i.label}: ${s.value}`), (t += s.html);
                    }
                }
                return t;
        ...
        if (-1 == t.indexOf('id') || -1 == t.indexOf('pid')) {
            ...
            return (
                ...
                (document.onmouseup = function (t) {
                    (t = t || window.event),
                        a._dragging && ((a.style.left = a._originalLeft + t.clientX - a._mouseLeft + 'px'), (a.style.top = a._originalTop + t.clientY - a._mouseTop + 'px'), (a._dragging = !1));
                }),
                a
            );
        }
            ...
            var O = function (t, e) {
                    ...
                    if (p) {
                        ...
                        if (s.left || s.right || s.up || s.down) {
                            ...
                            for (
                                o.moveEnd(),
                                    g.classList &&
                                        (g.classList.add('boc-cursor-grab'), g.classList.remove('boc-cursor-move'), g.classList.remove('boc-cursor-nodrop'), g.classList.remove('boc-cursor-copy')),
                                    O(d, c),
                                    d = null,
                                    c = null;
                                null != i && i != g;
                            ...
                            if (
                                ...
                                !1 === OrgChart.events.publish('drag', [o.nodeCircleMenuUI, { from: I, menuItem: n, menuItemName: a }]) && x(), (t._dragEventFired = !0);
                            u.setAttribute('transform', 'matrix(' + f.toString() + ')');
                        }
                    }
                },
                x = function (e) {
                    if (
                        ...
                        return (
                            g.removeChild(u), (o._gragStartedId = null), void (t._dragEventFired && OrgChart.events.publish('drop', [o.nodeCircleMenuUI, { from: s.id, menuItemName: a, menuItem: n }]))
                        );
                    var i = o.getNode(d);
                    OrgChart.events.publish('drop', [o.nodeCircleMenuUI, { from: s.id, to: i.id, menuItem: n, menuItemName: a }]), O(d, c), g.removeChild(u), (o._gragStartedId = null);
                };
                    ...
                    if (d) {
                        ...
                        if (C.left || C.right || C.up || C.down) {
                            ...
                            if (
                                (s.moveEnd(),
                                h.classList &&
                                    (h.classList.add('boc-cursor-grab'), h.classList.remove('boc-cursor-move'), h.classList.remove('boc-cursor-nodrop'), h.classList.remove('boc-cursor-copy')),
                                m(o, l),
                                (o = null),
                                (l = null),
                            ...
                            if (('draging' == o && ((o = null), (l = null)), null != o)) {
                                ...
                                !s.canUpdateLink(n.id, o) && h.classList
                                    ...
                                    : h.classList &&
                                      (h.classList.remove('boc-cursor-grab'), h.classList.remove('boc-cursor-move'), h.classList.add('boc-cursor-copy'), h.classList.remove('boc-cursor-nodrop'));
                            }
                            var N = (r.x - d.x) / u,
                                L = (r.y - d.y) / u;
                            if (
            ...
            if (!this._moveInterval) {
                ...
                OrgChart.isNEU(r) && (r = OrgChart.anim.inSin),
                    ...
                    (this._moveInterval = setInterval(function () {
                        ...
                        t.left
                            ? (l++, (d.x = (l * OrgChart.MOVE_STEP) / o), (d.xWithoutScale = l * OrgChart.MOVE_STEP))
                            : t.right && (l++, (d.x = (-l * OrgChart.MOVE_STEP) / o), (d.xWithoutScale = -l * OrgChart.MOVE_STEP)),
                            t.up
                                ? (s++, (d.y = (s * OrgChart.MOVE_STEP) / o), (d.yWithoutScale = s * OrgChart.MOVE_STEP))
                                : t.down && (s++, (d.y = (-s * OrgChart.MOVE_STEP) / o), (d.yWithoutScale = -s * OrgChart.MOVE_STEP));
                        var c = r((10 * h - 10) / i);
                        (d.x = d.x * c),
    ...
    (OrgChart.searchUI.prototype.init = function (t) {
        ...
        var d = function () {
                ...
                null == r && t.length > 0
                    ...
                    : t.length > 0 && r.nextSibling && r.nextSibling.setAttribute && (r.removeAttribute('data-selected'), r.nextSibling.setAttribute('data-selected', 'yes'));
            },
            c = function () {
                var t = e.obj.element.querySelectorAll('[data-search-item-id]'),
                    r = e.obj.element.querySelector('[data-selected="yes"]');
    ...
    (OrgChart.manager._createNodes = function (t) {
        ...
        if (i == OrgChart.action.init && e.expand && e.expand.nodes && null == o)
            for (d = 0; d < e.expand.nodes.length; d++) {
                ...
                for (!0 === e.expand.allChildren && OrgChart.manager._addExpandedNodeIdsIterate(C, l, m); C; )
                    m.push(C.id), null == C.pid && null != C.stpid ? ((C = l[C.stpid]).min = !1) : (C = l[C.pid]);
            }
            ...
            for (d = 0; d < b.length; d++) for (var O = l[(C = l[b[d]]).pid]; O; ) m.push(O.id), null == O.pid && null != O.stpid ? ((O = l[O.stpid]).min = !1) : (O = l[O.pid]);
        ...
        for (d = 0; d < I.length; d++) {
            ...
            for (x = 0; x < C.children.length; x++) {
                (D = C.children[x]).isAssistant
                    ...
                    ? -1 != D.tags.indexOf('partner') && M % 2
                        ...
                        : D.parentPartner
                        ? (L[D.parentPartner.id] || (L[D.parentPartner.id] = []), L[D.parentPartner.id].push(D.id))
                        : A.push(D.id)
            ...
            for (x = 0; x < R.length; x++) {
                (D = l[R[x]]).collapsed || ((D.parentPartner = D.parent), (D.parent = C), (D.isChildOfPartner = !0), C.children.push(D));
            }
            for (x = N.length - 1; x >= 0; x--) if (L[N[x]]) for (f = 0; f < L[N[x]].length; f++) C.children.push(l[L[N[x]][f]]), T++, -1 == P.indexOf(N[x]) && P.push(N[x]);
            for (x = 0; x < A.length; x++) {
                var D = l[A[x]];
                C.children.push(D);
            }
            for (x = 0; x < E.length; x++) if (L[E[x]]) for (f = 0; f < L[E[x]].length; f++) C.children.push(l[L[E[x]][f]]), B++, -1 == U.indexOf(E[x]) && U.push(E[x]);
        ...
        for (d = 0; d < k.length; d++) {
            var j = r[(C = l[k[d]]).lcn ? C.lcn : 'base'];
            for (x = 0; x < C.subLevels; x++) {
                var z,
                    Y = new OrgChart.node(C.id + '_sub_level_index_' + x, C.pid, [], 'subLevel');
                if ((OrgChart.manager._initDinamicNode(Y, C.lcn), (O = C.parent)))
                    (z = O.children.indexOf(C)) > -1 && (O.children.splice(z, 1), O.children.splice(z, 0, Y)), Y.children.push(C), (Y.parent = O), (C.parent = Y), (l[Y.id] = Y);
            }
        }
        for (var X in w) {
            (O = l[X]).hasAssistants = !0;
            Y = new OrgChart.node(O.id + '_split_assitant_0', O.id, ['assistant'], 'split');
            OrgChart.manager._initDinamicNode(Y, O.lcn, !0), (l[Y.id] = Y);
            var q = [];
            for (x = O.children.length - 1; x >= 0; x--) {
                (D = O.children[x]).isAssistant
                    ? ((D.parent = null), O.children.splice(x, 1), q.splice(0, 0, D.id))
                    : D.isPartner ||
                      (D.parent && S[D.parent.id] && Y && D.parent.id != Y.id && (Object.defineProperty(S, Y.id, Object.getOwnPropertyDescriptor(S, D.parent.id)), delete S[D.parent.id]),
                      (D.parent = Y),
                      Y.children.unshift(D),
                      O.children.splice(x, 1));
            }
            if (q.length % 2) {
                var $ = l[q[q.length - 1]],
                    V = new OrgChart.node($.id + '_mirror', O.pid, [], 'mirror');
                OrgChart.manager._initDinamicNode(V, $.lcn, !0), ($._m = V.id), (V.isAssistant = !0), (V.w = $.w), (V.h = $.h), (l[V.id] = V), q.splice(q.length - 1, 0, V.id);
            }
            var G = 1;
            for (x = q.length - 1; x >= 0; x--)
                if (x % 2 && x != q.length - 1) {
                    var W = new OrgChart.node(O.id + '_split_assitant_' + G, O.pid, [], 'split');
                    OrgChart.manager._initDinamicNode(W, O.lcn, !0), (l[W.id] = W), q.splice(x, 0, W.id), G++;
                } else x % 2 && q.splice(x, 0, Y.id);
            for (x = 0; x < q.length; x += 3) {
                ...
                var K = l[q[x]],
                    Z = l[q[x + 1]],
                    Q = l[q[x + 2]];
                (K.parent = J), (Z.parent = J), (Q.parent = J), J.children.push(K), J.children.push(Z), J.children.push(Q);
            }
        }
        var tt = !1;
        for (var et in r) {
        ...
        var rt = OrgChart.events.has('node-layout', t._event_id);
        if (tt || rt) {
            var it = { nodes: l, config: e, action: i, actionParams: a },
                at = [];
            for (var X in S)
                if (S[X].length > 0 && k.has(S[X][0])) {
                    at.push(X);
                    var nt = l[S[X][0]].parent.id;
                    S[nt] = S[X];
                    for (d = l[X].children.length - 1; d >= 0; d--) {
                        D = l[X].children[d];
                        S[nt].has(D.id) && l[X].children.splice(d, 1);
                    }
                }
            for (var X in S)
                if (!at.has(X)) {
                    for (var ot = (O = l[X]); ot.isSplit; ) ot = l[ot.pid];
                    for (; ot.isSubLevel; ) ot = l[ot.pid];
                    if ((j = r[O.lcn ? O.lcn : 'base']).layout > 0 || rt)
                        if (
                            ((it.pnode = O),
                            (it.layout = j.layout),
                            (it.childrenIds = S[X]),
                            (it.lastChildrenPidIds = S),
                            OrgChart.events.publish('node-layout', [t, it]),
                            OrgChart.events.publish('layout', [it]),
                            it.layout == OrgChart.layout.mixed)
                        ) {
                            var lt = it.childrenIds;
                            for (d = lt.length - 1; d >= 0; d--) {
                                (O = (D = l[lt[d]]).parent), (D.layout = OrgChart.layout.mixed);
                                for (x = O.children.length - 1; x >= 0; x--)
                                ...
                                if (d > 0) {
                                    var st = l[lt[d - 1]];
                                    (D.parent = st), (D.layout = OrgChart.layout.mixed), st.children.push(D);
                                } else O.children.push(D);
                            }
                        } else if (it.layout > 1) {
                            Y = new OrgChart.node(O.id + '_split_0', ot.id, [], 'split');
                            OrgChart.manager._initDinamicNode(Y, O.lcn), (l[Y.id] = Y), (Y.layout = it.layout);
                            var ht = [];
                            for (d = it.childrenIds.length - 1; d >= 0; d--) {
                                for (D = l[it.childrenIds[d]], x = 0; x < O.children.length; x++) O.children[x].id == D.id && O.children.splice(x, 1);
                                if (
                                    ((D.parent = null),
                                    (D.layout = it.layout),
                                    (it.layout != OrgChart.layout.treeRightOffset && it.layout != OrgChart.layout.treeRight) || ht.splice(0, 0, D.id),
                                    it.layout > 2)
                                ) {
                                    var dt = new OrgChart.node(D.id + '_mirror', ot.id, [], 'mirror');
                                    OrgChart.manager._initDinamicNode(dt, D.lcn), (dt.layout = it.layout), (l[dt.id] = dt), ht.splice(0, 0, dt.id);
                                }
                                it.layout != OrgChart.layout.treeRightOffset && it.layout != OrgChart.layout.treeRight && ht.splice(0, 0, D.id);
                            }
                            for (G = 1, x = ht.length - 1; x >= 0; x--)
                                if (x % 2 && x != ht.length - 1) {
                                    W = new OrgChart.node(O.id + '_split_' + G, ot.id, [], 'split');
                                    OrgChart.manager._initDinamicNode(W, O.lcn), (W.layout = it.layout), (l[W.id] = W), ht.splice(x, 0, W.id), G++;
                                } else x % 2 && ht.splice(x, 0, Y.id);
                            for (x = 0; x < ht.length; x += 3) {
                                J = null;
                                0 == x && (J = O);
                                (K = l[ht[x]]), (Z = l[ht[x + 1]]), (Q = l[ht[x + 2]]);
                                0 != x && (J = l[ht[x - 3]]),
                                    0 == x || Z || (J = l[ht[x - 2]]),
                                    (K.parent = J),
                                    J.children.push(K),
                                    Z && (0 != x && (J = l[ht[x - 2]]), (Z.parent = J), J.children.push(Z)),
                                    Q && (0 != x && (J = l[ht[x - 1]]), (Q.parent = J), J.children.push(Q));
                            }
                        }
                }
        }
        ...
        it = { nodes: l, roots: s };
        return OrgChart.events.publish('nodes-initialized', [t, it]), { nodes: it.nodes, roots: it.roots, rootList: h };
    }),
    ...
    (OrgChart.templates.deborah.field_0 =
        '<text ' + OrgChart.attr.width + '="125" ' + OrgChart.attr.text_overflow + '="ellipsis" style="font-size: 18px;" fill="#ffffff" x="15" y="25" text-anchor="start">{val}</text>'),
    (OrgChart.templates.deborah.field_1 =
        '<text ' + OrgChart.attr.width + '="105" ' + OrgChart.attr.text_overflow + '="ellipsis" style="font-size: 11px;" fill="#ffffff" x="15" y="135" text-anchor="start">{val}</text>'),
    ...
    (OrgChart.templates.group_dotted_lines.nodeGroupDottedCloseButton =
        '<g transform="matrix(1,0,0,1,{ew},0)"><circle cx="0.5" cy="21.5" r="12" fill="#F57C00"></circle>' + OrgChart.icon.close(25, 25, '#fff', -13, 8) + '</g>'),
                        ...
                        ? ((u.ppnodes[m.id] = m.parentPartner),
                          ...
                          1 == m.parentPartner.isPartner
                              ...
                              : 2 == m.parentPartner.isPartner &&
                                (-1 == u.leftIds.indexOf(m.parentPartner.id) && u.leftIds.push(m.parentPartner.id), (u.indexes[m.id] = u.leftIds.indexOf(m.parentPartner.id)), (u.lastLeft = m)))
    ...
    (OrgChart.mergeDeep = function (t, e) {
        if (OrgChart.isObject(t) && OrgChart.isObject(e))
            for (var r in e) OrgChart.isObject(e[r]) ? (t[r] || Object.assign(t, { [r]: {} }), OrgChart.mergeDeep(t[r], e[r])) : Object.assign(t, { [r]: e[r] });
        return t;
    }),
        ...
        function n(e, n, o) {
            ...
            switch ((p = OrgChart.slinkTemplates[k]).labelPosition) {
                ...
                case 'middle':
                    ...
                    (S = s[E]), (I = s[E - 1]), (A = { x: (S[0] + I[0]) / 2, y: (S[1] + I[1]) / 2 });
                    break;
                case 'end':
            ...
            o && ((U = n.id), (P = e.id)),
                (r +=
                    ('<g ' + OrgChart.attr.s_link_from + '="{from}" ' + OrgChart.attr.s_link_to + '="{to}">').replace('{from}', U).replace('{to}', P) +
            ...
            if (t.manager.action != OrgChart.action.move) {
                (OrgChart.miniMap._settings._scale = Math.min(
                    ...
                    (OrgChart.miniMap._settings._translateX =
                        ...
                        (OrgChart.miniMap.width - (t.response.boundary.maxX - t.response.boundary.minX) * OrgChart.miniMap._settings._scale) / 2),
                    (OrgChart.miniMap._settings._translateY =
                        -t.response.boundary.minY * OrgChart.miniMap._settings._scale +
                        (OrgChart.miniMap.height - (t.response.boundary.maxY - t.response.boundary.minY) * OrgChart.miniMap._settings._scale) / 2);
                var r = t.getViewBox();
        ...
        if (!t.element.querySelector('[data-id="mini-map"]')) {
            ...
            for (var a = ['top', 'right', 'left', 'bottom'], n = 0; n < a.length; n++) {
                ...
                OrgChart.isNEU(OrgChart.miniMap.position[o]) ||
                    ('padding' == OrgChart.miniMap.position[o] ? (i.style[o] = t.config.padding + 'px') : (i.style[o] = OrgChart.miniMap.position[o] + 'px'));
            }
    ...
    (OrgChart._search.addNodeToResult = function (t, e, r, i, a, n) {
        ...
        null != i &&
            (OrgChart.isNEU(o.__score) && (o.__score = i.__score), OrgChart.isNEU(o.__searchField) && (o.__searchField = a), OrgChart.isNEU(o.__searchMarks) && (o.__searchMarks = i.__searchMarks)),
            t.push(o);
    }),
        ...
        return (
            e.btn && (n = `<a href="#" data-input-btn="" class="boc-link boc-link-boc-button">${e.btn}</a>`),
            {
                html: `<div class="boc-form-field" style="min-width: ${r};">\n                    <div class="boc-input" data-boc-input="" ${a.disabledAttribute} ${
                    ...
                    a.readOnlyAttribute
                } data-binding="${OrgChart._escapeDoubleQuotes(a.binding)}" maxlength="256" id="${a.id}" name="${a.id}" type="text" value="${OrgChart._escapeDoubleQuotes(
                    a.value
                )}" autocomplete="off">\n                        ${n}\n                    </div>\n                </div>`,
                id: a.id,
                value: a.value,
    ...
    (OrgChart.elements.checkbox = function (t, e, r, i) {
        ...
        return {
            html: `<div class="boc-form-field"  style="min-width: ${r};" >\n                        <label class="boc-checkbox" data-boc-input="" ${
                ...
                a.binding
            )}" type="checkbox"><span class="boc-checkbox-checkmark" type="checkbox"></span>${OrgChart._escapeGreaterLessSign(a.label)}\n                        </label>\n                    </div>`,
            id: a.id,
            value: n,
        };
    }),
    ...
    (OrgChart.elements.date = function (t, e, r, i) {
        ...
        return a.doNotRender
            ...
            : {
                  html: `<div class="boc-form-field" style="min-width: ${r};">\n                    <div class="boc-input" data-boc-input="" ${a.disabledAttribute} ${
                      a.vlidators
                  }>\n                        <label for="${a.id}" class="hasval">${OrgChart._escapeGreaterLessSign(
                      a.label
                                                ...
                                                if (o[l][r] == this.name)
                                                    for (var s = o[l]; s; )
                                                        if (OrgChart.isNEU(s.stpid)) s = OrgChart.isNEU(s.pid) ? null : h.instance._get(s.pid);
                                                            ...
                                                            d
                                                                ? ((d.checked = this.checked), (h.filterBy[r][s[r]].checked = this.checked))
